...
class GLES_100_PP_scope_v2{
	static public var map:Map<String, Int> = [
		...
		"statement ::= compound_statement_with_scope" => 169,
		"statement ::= simple_statement" => 170,
		"statement_no_new_scope ::= compound_statement_no_new_scope" => 171,
		"statement_no_new_scope ::= simple_statement" => 172,
		"statement_with_scope ::= scope_push compound_statement_no_new_scope scope_pop" => 173,
		"statement_with_scope ::= scope_push simple_statement scope_pop" => 174,
		"simple_statement ::= declaration_statement" => 175,
		"simple_statement ::= expression_statement" => 176,
		"simple_statement ::= selection_statement" => 177,
		"simple_statement ::= iteration_statement" => 178,
		"simple_statement ::= jump_statement" => 179,
		"simple_statement ::= preprocessor_directive" => 180,
		"compound_statement_with_scope ::= LEFT_BRACE RIGHT_BRACE" => 181,
		"compound_statement_with_scope ::= LEFT_BRACE scope_push statement_list scope_pop RIGHT_BRACE" => 182,
		"compound_statement_no_new_scope ::= LEFT_BRACE RIGHT_BRACE" => 183,
		"compound_statement_no_new_scope ::= LEFT_BRACE statement_list RIGHT_BRACE" => 184,
		"statement_list ::= statement" => 185,
		"statement_list ::= statement_list statement" => 186,
		"expression_statement ::= SEMICOLON" => 187,
		"expression_statement ::= expression SEMICOLON" => 188,
		"selection_statement ::= IF LEFT_PAREN expression RIGHT_PAREN selection_rest_statement" => 189,
		"selection_rest_statement ::= statement_with_scope ELSE statement_with_scope" => 190,
		"selection_rest_statement ::= statement_with_scope" => 191,
		"condition ::= expression" => 192,
		"condition ::= fully_specified_type IDENTIFIER EQUAL initializer" => 193,
		"iteration_statement ::= WHILE LEFT_PAREN scope_push condition RIGHT_PAREN statement_no_new_scope scope_pop" => 194,
		"iteration_statement ::= DO statement_with_scope WHILE LEFT_PAREN expression RIGHT_PAREN SEMICOLON" => 195,
		"iteration_statement ::= FOR LEFT_PAREN scope_push for_init_statement for_rest_statement RIGHT_PAREN statement_no_new_scope scope_pop" => 196,
		"for_init_statement ::= expression_statement" => 197,
		"for_init_statement ::= declaration_statement" => 198,
		"conditionopt ::= condition" => 199,
		"conditionopt ::=" => 200,
		"for_rest_statement ::= conditionopt SEMICOLON" => 201,
		"for_rest_statement ::= conditionopt SEMICOLON expression" => 202,
		"jump_statement ::= CONTINUE SEMICOLON" => 203,
		"jump_statement ::= BREAK SEMICOLON" => 204,
		"jump_statement ::= RETURN SEMICOLON" => 205,
		"jump_statement ::= RETURN expression SEMICOLON" => 206,
		"jump_statement ::= DISCARD SEMICOLON" => 207,
		...
		"external_declaration ::= preprocessor_directive" => 212,
		"function_definition ::= function_prototype scope_push compound_statement_no_new_scope scope_pop" => 213,
		"preprocessor_directive ::= PREPROCESSOR_DIRECTIVE" => 214,
		"scope_push ::=" => 215,
		"scope_pop ::=" => 216
	];
}