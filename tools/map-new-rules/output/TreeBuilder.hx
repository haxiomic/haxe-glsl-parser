	...
	static public function buildRule(ruleno:Int):MinorType{
		...
		switch(ruleno){
			...
			*/
			...
			case 179: return s(1); //statement_with_scope ::= compound_statement_no_new_scope
			...
			case 215: trace('scope_push'); return null; //scope_push ::=
			case 216: trace('scope_pop'); return null; //scope_pop ::=
		}
...
class Debug{
	static public var ruleMap:Map<Int, String> = [
		...
		178 => 'compound_statement_with_scope ::= LEFT_BRACE scope_push statement_list scope_pop RIGHT_BRACE',
		179 => 'statement_with_scope ::= compound_statement_no_new_scope',
		180 => 'statement_with_scope ::= scope_push simple_statement scope_pop',
		...
		194 => 'iteration_statement ::= FOR LEFT_PAREN scope_push for_init_statement for_rest_statement RIGHT_PAREN statement_no_new_scope scope_pop',
